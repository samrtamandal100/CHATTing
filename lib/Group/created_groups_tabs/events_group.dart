...
class EventsGroup extends StatefulWidget {
  const EventsGroup({super.key});

  @override
  State<EventsGroup> createState() => _EventsGroupState();
}

class _EventsGroupState extends State<EventsGroup> {
  List<String> name = [
    'Ankit Mandal',
    'Samrat Sharma',
    'Sayan RoyGupta',
