...
class PostsGroup extends StatefulWidget {
  const PostsGroup({super.key});

  @override
  State<PostsGroup> createState() => _PostsGroupState();
}

class _PostsGroupState extends State<PostsGroup> {
  List<String> name = [
    'Ankit Mandal',
    'Samrat Sharma',
    'Sayan RoyGupta',
